...
export const AWS_REGION:string = process.env.AWS_REGION?process.env.AWS_REGION:'us-east-1';
...
export const COGNITO_APP_CLIENT_ID:string = process.env.COGNITO_APP_CLIENT_ID?process.env.COGNITO_APP_CLIENT_ID:'';
